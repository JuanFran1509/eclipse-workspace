...
public class pruebaConexion {
	...
	public static void main(String[] args) {
		...
		// IMPORTANTE: Esto se hacia en versiones de java anteriores a la 1.7 y con
		// drivers
		 ...
		 * e) { System.out.println("No se ha encontrado el driver para MySQL"); return;
		 * }
		 * 
		...
		// 3306, el puerto por el que nos vamos a contectar, por defecto mysql es el
		// 3306
		// bbdd, es el esquema de la bbdd a al que nos queremos conectar
		String cadenaConexion = "jdbc:mysql://localhost:3306/coches";
		String user = "root";
		String pass = ""; // sustituye por la contraseña que especificaste durante la instalación de
							// MySQL.

		// Paso 2: crear el objeto que realizará la conexión, este paso habra que
		// hacerlo
